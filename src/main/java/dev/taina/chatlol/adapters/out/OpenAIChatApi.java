...
// utilizando OpenAI API: https://platform.openai.com/docs/api-reference/chat/create

// especificar qual client (openai ou gemini) está ativo para acesso a IA Generativa
// configuração em application.yml
@ConditionalOnProperty(name = "${generative-ai.provider}", havingValue = "OPENAI", matchIfMissing = true)
// criando um client http utilizando feign -> biblioteca especializada nisso
...
public interface OpenAIChatApi extends GenerativeAIApi {
    ...
    default String generateContext(String objective, String context) {
        ...
        try {
            ...
            return "Erro de comunicação com a OPENAI API.";
